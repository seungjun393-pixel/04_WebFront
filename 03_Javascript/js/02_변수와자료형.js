...
// 즉, 코드블럭 내부에서 선언한 변수(let, const)는 
// 해당 블럭 외부에서는 접근할 수 없다

let fool1 = 123; // 전역 변수
const fool2 = 456; // 전역 변수(상수)
...
console.log(fool1); // 전역변수이기 때문에 (블럭과 관계없음) 접근 가능
console.log(fool2); // 전역변수이기 때문에 (블럭과 관계없음) 접근 가능
// console.log(num1);
// console.log(num2);
...
// TDZ(Temproal Dead Zone) : 시간적으로 죽은 구역
...
// -> 초기화가 이러우지기 전까지 해당 변수는 TDZ에 놓이며,
// 이 기간동안 변수에 접근하려고 하면
...
const gender = 'M'; // 홑따옴표에 한글자만 작성해도 문자열(string)
...
// 1) 배열(Array) : 여러값이 나열되어 있는 것의 유형
const numbers = [10, 20, 30];

console.log("numbers : ", numbers, typeof numbers);

console.log("numbers 배열 값 중 1번째 : ", numbers[0], typeof numbers[0]);
console.log("numbers 배열 값 중 2번째 : ", numbers[1], typeof numbers[1]);
console.log("numbers 배열 값 중 3번째 : ", numbers[2], typeof numbers[2]);
console.log("numbers 배열 값 중 4번째 : ", numbers[3], typeof numbers[3]);

// JS에서 배열의 값은 추가 및 삭제 가능
